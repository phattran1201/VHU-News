...
import { View, Text, StyleSheet, Image, ScrollView,Platform,focused,FlatList,Linking } from "react-native";
    ...
    return (
      ...
      <FlatList data={this.state.mang}
        ...
        <Card >
          ...
          <CardItem  onPress={() => {navigate('GetLink', { link: item.LINK,tieude: item.TIEUDE, linkdemo:'https://www.facebook.com/sharer/sharer.php?u=' })}} cardBody >
            <Image
              source={{ uri: item.URL }}
          ...
          <CardItem style={{ height: 45 }}>
            ...
            <Right>
              ...
              <Button
                transparent
                onPress={() => {navigate('GetLink', { link: item.LINK,tieude: item.TIEUDE, linkdemo:'https://www.facebook.com/sharer/sharer.php?u=' })}}
              >
                  <Text note>{item.TIME}</Text>
              </Button>
            </Right>
          ...
          <CardItem>
            <Body>
              <Text onPress={() => {navigate('GetLink', { link: item.LINK,tieude: item.TIEUDE, linkdemo:'https://www.facebook.com/sharer/sharer.php?u=' })}} style={{ fontWeight: "900" }}>{item.TIEUDE}</Text>
              {/* <Text>
                {" "}
